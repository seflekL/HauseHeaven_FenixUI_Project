...
public class TC_ME04 extends TestBaseRapor {
    ...
    public void test04(){
        ...
        extentTest=extentReports.createTest(" Testimonials sayfasında  save&exit butonuyla yorum düzenlenebildiği testi");
        ...
        extentTest.pass("Admin gerekli düzenlemeleri yaptıktan sonra save&exit butonuna tıklar .update successfully penceresı göründüğünde yapılan değişikliklerin kaydedildiğini doğrular. ");
