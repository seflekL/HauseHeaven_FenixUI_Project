...
public class TC_M012 extends TestBaseRapor {

    @Test
    public void Test12 (){

        extentTest = extentReports.createTest("KK olarak websitesinde gezinirken " +
                "Home’a tıklayarak anasayfaya ulaşabilme testi.");
        ...
        extentTest.pass("Tekrar Anasayfa'ya gelindiği test edildi.");
