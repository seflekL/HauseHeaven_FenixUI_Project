...
public class TC_IK010 extends TestBaseRapor {

    @Test
    public void test04() {
        extentTest = extentReports.createTest("Admin olarak giriş yapıp Real Estate başlığının altındaki Investors sayfasında herhangi bir yatırımcıyı silmek istiyorum");
        ...
        IsmailMethods.getYatirimciSilme(1);
