...
public class TC_04_negatifDDMTesti extends TestBaseRapor {
    ...
    public void TC_04 (){
        ...
        extentTest.pass("Ziyaretci belirtilen URL'ye giris yapar.");
        ...
        extentTest.pass("Ziyaretci 'Search for Location' kutusuna tiklar.");
        //Ziyaretci  searchbox'a istedigi ulke veya sehir ismini yazar
        homePage.sefUserSearhforloactionboxElementi.sendKeys("New York");
        extentTest.pass("Ziyaretci 'Search Box' alanina istedigi ulke veya sehir ismini yazar.");
        ...
        extentTest.pass("Ziyaretci 'Min Price' dropdown menusunden istedigi fiyati secer.");
        ...
        extentTest.pass("Ziyaretci 'Max Price' dropdown menusunden istedigi fiyati secer.");
        ...
        extentTest.pass("Ziyaretci 'Property Type' dropdown menusunden istedigi ev turunu secer.");
        ...
        extentTest.pass("Ziyaretci 'Bed Rooms' dropdown menusunden istedigi yatak odasi turunu secer.");
        //Ziyaretci acilan  tarayici kapatir
        Driver.quitDriver();
        extentTest.pass("Ziyaretci acilan tarayiciyi kapatir.");
